'''
Author: lidong
Date: 2021-07-02 14:06:11
LastEditors: lidong
LastEditTime: 2021-07-05 11:08:51
...
class MobileNetSeg(BaseBackbone):
    def __init__(self, base_name,head_conv=24, pretrained = True, **kwargs):
        ...
        self.kwargs = kwargs
        self.set_input_shape(self.kwargs['input_shape'])
...
# num_layers  : [10 , 5]
def get_mobile_net(num_layers, head_conv=24, **kwargs):
  model = MobileNetSeg('mobilenetv2_{}'.format(num_layers), head_conv=head_conv,
