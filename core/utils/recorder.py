...
LastEditors: lidong
LastEditTime: 2021-06-17 16:28:09
...
class UnWarppedModel(torch.nn.Module):
...
class Recorder:
    def __init__(self, cfg):
        ...
        self.summary_writer = SummaryWriter(self.summary_writer_path, comment=self.task_name+'_'+get_time_stamp())
    ...
    def start_batch(self):
        self.batch_id = 0
        self.loss_meter_batch_train = AverageMeter(name=f'BatchLoss')
    ...
    def log_batch_info(self):
        ...
        + '[' + str(self.loss_meter_batch_train) +']'
    ...
    def record_epoch(self, net):
        ...
        self.loss_meter_epoch_train.update(self.loss_meter_batch_train.avg)
        self.summary_writer.add_scalar(
            f'train_loss', self.loss_meter_batch_train.avg, self.epoch_id)
        self.epoch_id += 1
    ...
    def save_checkpoint(self, net: torch.nn.Module):
        ...
        torch.save(net.state_dict(), self.chpt_save_fmt.format(self.epoch_id-1))
    ...
    def viz_network(self, net, input_shape):
        ...
        self.summary_writer.add_graph(net, dummy)