'''
Author: lidong
Date: 2021-07-02 16:32:15
LastEditors: lidong
LastEditTime: 2021-07-06 15:33:50
...
from core.models.loss.utils import _tranpose_and_gather_feat
...
class FullRegL1Loss(nn.Module):
  def __init__(self, **kwargs):
    super(FullRegL1Loss, self).__init__()
